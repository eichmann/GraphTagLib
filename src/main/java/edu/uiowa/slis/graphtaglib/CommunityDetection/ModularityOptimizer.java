...
public class ModularityOptimizer {
	...
	if (printOutput) {
	    ...
	    System.out.println("Running "
		    + ((algorithm == 1) ? "Louvain algorithm" : ((algorithm == 2) ? "Louvain algorithm with multilevel refinement"
	...
	while ((buffer = bufferedReader.readLine()) != null) {
	    ...
	    Detector.logger.info("node1: " + node1Vector.lastElement() + " node2: " + node2Vector.lastElement() + " weight: " + edgeWeightVector.lastElement());
	}
